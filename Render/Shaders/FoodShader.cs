...
{
    internal sealed class FoodShader : GLShader
    {
        private const string VERTEX_SHADER_PATH = @"Shaders\Food.vert.glsl";
        private const string FRAGMENT_SHADER_PATH = @"Shaders\Food.frag.glsl";
